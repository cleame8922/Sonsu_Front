...
return (
    ...
    <div className="h-full pt-[100px] ">
        ...
        <div className="flex justify-center gap-16">
            ...
            <button className="px-6 py-2 text-white transition-colors bg-yellow-500 rounded-lg hover:bg-yellow-400">
                시작하기
            </button>
            </div>
            ...
            <button className="px-6 py-2 text-white transition-colors bg-blue-500 rounded-lg hover:bg-blue-400">
                시작하기
            </button>
            </div>
        </div>
