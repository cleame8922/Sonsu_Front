...
export default function AdminMain2() {
  return (
    <div>
      {/* 흰배경 */}
      <div className="text-[#404040] text-[25px] leading-10 w-full bg-white h-[400px] flex flex-col items-center justify-center">
      ...
      <div className="h-screen flex items-center justify-center">
        <div className="flex flex-col items-center gap-12">
          ...
          <div className="text-center">
            <p className="text-[60px] text-[#333] font-semibold">SONSU CLASS</p>
          ...
          <div className="flex items-center justify-center gap-12">
            <div className="flex flex-col items-center">
              <img
                ...
                className="w-[500px]"
              />
              <p className="text-[32px] text-[#333] font-bold mt-4">
                강의 커리큘럼
              </p>
              <div className="text-[#333] text-[20px] flex flex-col items-center mt-2">
                <p>원하는 강의만 쏙쏙!</p>
                <p>뭐 어쩌구저쩌구</p>
              </div>
            </div>
