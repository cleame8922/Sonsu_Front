    ...
    <div className="px-32 h-screen mt-20">
      ...
      <div className="relative ml-60 mt-28">
        ...
        <div className="relative">
          <div className="w-[300px] absolute h-1 bg-[#999] absolute top-[135px] left-[500px]"></div>
          <div className="w-[30px] h-[30px] rounded-full bg-[#FFE694] absolute top-[122px] left-[800px]"></div>
        ...
        <div className="relative">
          <div className="w-[440px] absolute h-1 bg-[#999] absolute top-[310px] left-[500px]"></div>
          <div className="w-[30px] h-[30px] rounded-full bg-[#FFE694] absolute top-[297px] left-[920px]"></div>
          <div className="absolute top-[280px] left-[980px]">
        ...
        <div className="relative">
          <div className="w-[500px] absolute h-1 bg-[#999] absolute top-[600px] left-[500px]"></div>
          <div className="w-[30px] h-[30px] rounded-full bg-[#FFE694] absolute top-[588px] left-[970px]"></div>
          <div className="absolute top-[560px] left-[1040px]">
