...
export default function Main2() {
  return (
    <div className="">
      {/* 텍스트 */}
      <div className="text-[#404040] text-[25px] leading-10 w-full bg-[#FFE694] h-[400px] flex flex-col items-center justify-center">
      ...
      <div className="relative mt-32 min-h-[800px] w-[80%] mx-auto">
        ...
        <div className="absolute top-0 left-1/3 -translate-x-1/2">
          <div className="shadow-xl w-fit px-20 py-10 rounded-tl-[6rem] rounded-tr-[6rem] rounded-br-[6rem] bg-gradient-to-b from-white/70 to-white/100">
            <div className="text-[#DFAB00] font-bold text-[32px]">
              #게임처럼_배우는_수어학습
            </div>
            <div className="text-[21px] font-light whitespace-pre-line mt-3">
        ...
        {/* #누구나_쉽게_배울수있는_수어 */}
        <div className="absolute top-[230px] left-2/4 -translate-x-1/3">
        ...
        {/* #3D아바타로_직관적_학습 */}
        <div className="absolute top-[480px] left-[300px] z-12">
          <div className="shadow-xl w-fit px-20 py-10 rounded-tl-[6rem] rounded-tr-[6rem] rounded-br-[6rem] bg-gradient-to-b from-white/70 to-white/100">
            <div className="text-[#DFAB00] font-bold text-[32px]">
              #3D아바타로_직관적_학습
            </div>
